<%@ Page Title="" Language="C#" MasterPageFile="~/user/MasterUser.master" AutoEventWireup="true" CodeFile="MathsTest.aspx.cs" Inherits="user_Sachin" %>
   ...
   <%-- <div class="container">--%>
    ...
    <br />
        <asp:TextBox ID="txtScore" runat="server" visible="false">0</asp:TextBox>
            <h1 style="text-align: center; color: #990000" ><em>Aptitude Test</em></h1>
     ...
     <table align="center" width: "22%">
            <tr>
                <td>--%><asp:Button  runat="server"  class="nextbtn" Text="Next"  style="left:600px; z-index: 106; position: absolute; top: 370px"  ToolTip="Click Here to Take Next Question" ID="BunNext" OnClick="BunNext_Click" Font-Italic="True"     />
       <%--</td>
            </tr>
        </table>--%>
